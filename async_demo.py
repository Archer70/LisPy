...
def main():
    ...
    run_demo(
        "Basic async/await with resolved promise",
        '(async (await (resolve 100)))'
    )
    ...
    run_demo(
        ...
        '(defn-async compute-square [x] (* x x))'
    )
    ...
    run_demo(
        "Using complex async function",
        '(async (await (process-data 5 7)))'
    )
