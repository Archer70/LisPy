...
class RecurFormTest(unittest.TestCase):
    ...
    def test_tail_recursive_factorial(self):
        ...
        factorial_fn = [
            Symbol("define"),
            Symbol("factorial"),
            [Symbol("fn"), [Symbol("n")], [Symbol("factorial-tail"), Symbol("n"), 1]],
        ]
            ...
            [
                ...
                [
                    ...
                    [
                        Symbol("*"),
                        Symbol("n"),
                        [Symbol("factorial-regular"), [Symbol("-"), Symbol("n"), 1]],
                    ],
                ],
            ],
        ]
    ...
    def test_tail_call_with_multiple_parameters(self):
        ...
        self.assertEqual(
            evaluate([Symbol("sum-by-counting"), 100, 1000], self.env), 1100
        )
    ...
    def test_non_recursive_functions_unaffected(self):
        ...
        add_fn = [
            Symbol("define"),
            Symbol("add-two"),
            [Symbol("fn"), [Symbol("x")], [Symbol("+"), Symbol("x"), 2]],
        ]
        ...
        wrong_arity_fn = [
            ...
            [
                ...
                [
                    ...
                    [Symbol("="), Symbol("x"), 0],
                    Symbol("x"),
                    [Symbol("recur"), Symbol("x"), Symbol("x")],
                ],
            ],  # Too many args for recur
        ]
