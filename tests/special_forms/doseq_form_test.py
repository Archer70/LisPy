...
class DoseqFormTest(unittest.TestCase):
    ...
    def test_doseq_binding_not_vector(self):
        ...
        self.assertIn(
            "SyntaxError: 'doseq' first argument must be a vector", str(cm.exception)
        )
    ...
    def test_doseq_binding_not_symbol(self):
        ...
        self.assertIn(
            "SyntaxError: 'doseq' binding must be a symbol", str(cm.exception)
        )
    ...
    def test_doseq_collection_not_vector_or_list_number(self):
        ...
        self.assertIn(
            "TypeError: 'doseq' collection must be a vector or list", str(cm.exception)
        )
