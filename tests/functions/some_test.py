...
class SomeFnTest(unittest.TestCase):
    ...
    def test_some_with_mixed_types(self):
        ...
        result = run_lispy_string("(some [1 \"hello\" true {:a 1}] is_boolean?)", self.env)
        self.assertTrue(result)
    ...
    def test_some_preserves_predicate_return_value(self):
        ...
        run_lispy_string("(define return-double (fn [x] (if (is_number? x) (* x 2) false)))", self.env)
    ...
    def test_some_short_circuits(self):
        ...
        run_lispy_string("(define safe-check (fn [x] (if (= x 3) true (if (= x 0) (/ 1 x) false))))", self.env)
    ...
    def test_some_with_nested_collections(self):
        ...
        result = run_lispy_string("(some [1 \"hello\" '(1 2 3) {:a 1}] has-nested-list?)", self.env)
        self.assertTrue(result)
    ...
    def test_some_no_args(self):
        ...
        self.assertEqual(str(cm.exception), "SyntaxError: 'some' expects 2 arguments, got 0.")

    def test_some_one_arg(self):
        """Test (some [1 2]) raises an error."""
        with self.assertRaises(EvaluationError) as cm:
            run_lispy_string("(some [1 2])", self.env)
        self.assertEqual(str(cm.exception), "SyntaxError: 'some' expects 2 arguments, got 1.")
    ...
    def test_some_too_many_args(self):
        ...
        self.assertEqual(str(cm.exception), "SyntaxError: 'some' expects 2 arguments, got 3.")
    ...
    def test_some_non_function_predicate(self):
        ...
        self.assertEqual(str(cm.exception), "TypeError: Second argument to 'some' must be a function, got <class 'int'>.")
    ...
    def test_some_non_collection(self):
        ...
        self.assertEqual(str(cm.exception), "TypeError: First argument to 'some' must be a list or vector, got <class 'int'>.")
    ...
    def test_some_with_string_collection(self):
        ...
        self.assertEqual(str(cm.exception), "TypeError: First argument to 'some' must be a list or vector, got <class 'str'>.")
    ...
    def test_some_with_map_collection(self):
        ...
        self.assertEqual(str(cm.exception), "TypeError: First argument to 'some' must be a list or vector, got <class 'dict'>.")

    def test_some_functional_composition(self):
        """Test some can be used in functional composition."""
        run_lispy_string("(define has-positive? (fn [coll] (some coll (fn [x] (> x 0)))))", self.env)
