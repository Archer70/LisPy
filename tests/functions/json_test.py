...
class TestJSONFunctions(unittest.TestCase):
    ...
    def test_json_encode_maps(self):
        ...
        result = run_lispy_string(
            '(json-encode (hash-map (quote name) "Alice" (quote age) 30))', self.env
        )
    ...
    def test_json_decode_objects(self):
        ...
        result = run_lispy_string(
            '(json-decode "{\\"name\\": \\"Alice\\", \\"age\\": 30}")', self.env
        )
    ...
    def test_json_roundtrip(self):
        ...
        encoded_result = run_lispy_string(
        ...
        self.assertEqual(
            list(decoded_result[Symbol(":hobbies")]), ["reading", "coding"]
        )
