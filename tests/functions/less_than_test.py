# lispy_project/tests/functions/less_than_test.py
import unittest
...
class LessThanFunctionTest(unittest.TestCase):
    ...
    def test_less_than_true(self):
        ...
        self.assertTrue(run_lispy_string("(< 4.9 5)", self.env))
    ...
    def test_less_than_false(self):
        ...
        self.assertFalse(run_lispy_string("(< 5 5.0)", self.env))

    def test_less_than_type_error_arg_count(self):
    ...
    def test_less_than_type_error_non_numeric(self):
