...
from lispy.functions import (create_global_env, create_web_safe_env,
                             get_web_unsafe_bdd_forms,
                             get_web_unsafe_functions,
                             get_web_unsafe_special_forms)
from lispy.special_forms import (get_web_unsafe_special_forms,
    ...
    def test_web_safe_env_excludes_dangerous_functions(self):
        ...
        for func_name in unsafe_functions.keys():
            ...
            with self.assertRaises(
                EvaluationError,
                msg=f"Function '{func_name}' should not exist in web-safe environment",
            ):
    ...
    def test_web_safe_env_includes_safe_functions(self):
        ...
        for func_name in safe_functions:
            try:
                ...
                self.fail(
                    f"Safe function '{func_name}' should exist in web-safe environment"
                )
    ...
    def test_promise_functions_available(self):
        ...
        for func_name in promise_functions:
            try:
                ...
                self.fail(
                    f"Promise function '{func_name}' should be available in web-safe environment"
                )
    ...
    def test_type_checking_functions_available(self):
        ...
        for func_name in type_check_functions:
            try:
                ...
                self.fail(
                    f"Type check function '{func_name}' should be available in web-safe environment"
                )
    ...
    def test_bdd_functions_included(self):
        ...
        for func_name in bdd_functions:
            try:
                ...
                self.fail(
                    f"BDD function '{func_name}' should be available in web-safe environment"
                )
