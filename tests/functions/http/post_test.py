...
class TestHttpPost(unittest.TestCase):
    ...
    def test_http_post_successful_request(self, mock_urlopen):
        ...
        response = run_lispy_string('(await (http-post "https://httpbin.org/post"))', self.env)
    ...
    def test_http_post_with_json_data(self, mock_urlopen):
        ...
        response = run_lispy_string('(await (http-post "https://httpbin.org/post" {:name "Alice" :age 30}))', self.env)
    ...
    def test_http_post_with_string_data(self, mock_urlopen):
        ...
        response = run_lispy_string('(await (http-post "https://httpbin.org/post" "Hello World"))', self.env)
    ...
    def test_http_post_http_error_response(self, mock_urlopen):
        ...
        mock_error = HTTPError("https://httpbin.org/post", 400, "Bad Request", error_headers, None)
    ...
    def test_http_post_network_error(self, mock_urlopen):
        ...
        with self.assertRaises(EvaluationError) as context:
            run_lispy_string('(await (http-post "https://unreachable.example.com"))', self.env)
