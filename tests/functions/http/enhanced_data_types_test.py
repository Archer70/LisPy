...
from lispy.types import LispyPromise, Symbol, Vector, LispyList
...
class TestHTTPEnhancedDataTypes(unittest.TestCase):
    ...
    def create_mock_response(self, status=200, body='{"message": "success"}', headers=None):
    ...
    def test_post_vector_data(self, mock_urlopen):
        ...
        response = run_lispy_string('(await (http-post "https://httpbin.dev/post" [1 2 3]))', self.env)
    ...
    def test_post_lispy_list_data(self, mock_urlopen):
        ...
        response = run_lispy_string('(await (http-post "https://httpbin.dev/post" (list 1 2 3)))', self.env)
    ...
    def test_post_number_data(self, mock_urlopen):
        ...
        response = run_lispy_string('(await (http-post "https://httpbin.dev/post" 42))', self.env)
    ...
    def test_post_float_data(self, mock_urlopen):
        ...
        response = run_lispy_string('(await (http-post "https://httpbin.dev/post" 3.14159))', self.env)
    ...
    def test_post_boolean_true_data(self, mock_urlopen):
        ...
        response = run_lispy_string('(await (http-post "https://httpbin.dev/post" true))', self.env)
    ...
    def test_post_boolean_false_data(self, mock_urlopen):
        ...
        response = run_lispy_string('(await (http-post "https://httpbin.dev/post" false))', self.env)
    ...
    def test_post_none_data(self, mock_urlopen):
        ...
        response = run_lispy_string('(await (http-post "https://httpbin.dev/post" nil))', self.env)
    ...
    def test_put_enhanced_data_types(self, mock_urlopen):
        ...
        response = run_lispy_string('(await (http-put "https://httpbin.dev/post" [1 2 3]))', self.env)
    ...
    def test_delete_enhanced_data_types(self, mock_urlopen):
        ...
        response = run_lispy_string('(await (http-delete "https://httpbin.dev/post" 42))', self.env)
    ...
    def test_generic_request_enhanced_data_types(self, mock_urlopen):
        ...
        response = run_lispy_string('(await (http-request "POST" "https://httpbin.dev/post" true))', self.env)
    ...
    def test_empty_list_data(self, mock_urlopen):
        ...
        response = run_lispy_string('(await (http-post "https://httpbin.dev/post" []))', self.env)
    ...
    def test_mixed_type_list(self, mock_urlopen):
        ...
        response = run_lispy_string('(await (http-post "https://httpbin.dev/post" [1 "hello" true nil :test]))', self.env)
    ...
    def test_backward_compatibility_string_data(self, mock_urlopen):
        ...
        response = run_lispy_string('(await (http-post "https://httpbin.dev/post" "Hello World"))', self.env)
    ...
    def test_backward_compatibility_dict_data(self, mock_urlopen):
        ...
        response = run_lispy_string('(await (http-post "https://httpbin.dev/post" {:name "Alice" :age 30}))', self.env)
