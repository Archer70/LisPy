...
class EmptyFnTest(unittest.TestCase):
    ...
    def test_empty_arg_count_error_none(self):
        ...
        with self.assertRaises(EvaluationError) as cm:
            run_lispy_string("(empty?)", self.env)
        self.assertEqual(
            str(cm.exception), "SyntaxError: 'empty?' expects 1 argument, got 0."
        )
    ...
    def test_empty_arg_count_error_many(self):
        ...
        with self.assertRaises(EvaluationError) as cm:
            run_lispy_string('(empty? [] "")', self.env)
        self.assertEqual(
            str(cm.exception), "SyntaxError: 'empty?' expects 1 argument, got 2."
        )
    ...
    def test_empty_type_error_number(self):
        ...
        self.assertEqual(
            str(cm.exception),
            "TypeError: 'empty?' expects a list, vector, map, string, or nil. Got int",
        )
    ...
    def test_empty_type_error_boolean(self):
        ...
        self.assertEqual(
            str(cm.exception),
            "TypeError: 'empty?' expects a list, vector, map, string, or nil. Got bool",
        )
    ...
    def test_empty_type_error_function(self):
        ...
        self.assertEqual(
            str(cm.exception),
            "TypeError: 'empty?' expects a list, vector, map, string, or nil. Got Function",
        )
