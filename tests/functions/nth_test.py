...
class NthFnTest(unittest.TestCase):
    ...
    def test_nth_vector_out_of_bounds_no_default(self):
        ...
        self.assertEqual(
            str(cm.exception), "IndexError: 3 out of bounds for collection of size 3."
        )

        with self.assertRaises(EvaluationError) as cm:
            run_lispy_string("(nth [10 20 30] -1)", self.env)
        self.assertEqual(
            str(cm.exception), "IndexError: -1 out of bounds for collection of size 3."
        )
    ...
    def test_nth_empty_vector(self):
        ...
        self.assertEqual(
            str(cm.exception), "IndexError: 0 out of bounds for collection of size 0."
        )
    ...
    def test_nth_too_few_args(self):
        ...
        self.assertEqual(
            str(cm.exception), "SyntaxError: 'nth' expects 2 or 3 arguments, got 0."
        )

        with self.assertRaises(EvaluationError) as cm:
            run_lispy_string("(nth [1 2 3])", self.env)
        self.assertEqual(
            str(cm.exception), "SyntaxError: 'nth' expects 2 or 3 arguments, got 1."
        )
    ...
    def test_nth_too_many_args(self):
        ...
        self.assertEqual(
            str(cm.exception), "SyntaxError: 'nth' expects 2 or 3 arguments, got 4."
        )
    ...
    def test_nth_invalid_collection_type(self):
        ...
        self.assertEqual(
            str(cm.exception),
            "TypeError: 'nth' first argument must be a vector or list, got <class 'str'>.",
        )
        ...
        self.assertEqual(
            str(cm.exception),
            "TypeError: 'nth' first argument must be a vector or list, got <class 'int'>.",
        )
    ...
    def test_nth_invalid_index_type(self):
        ...
        self.assertEqual(
            str(cm.exception),
            "TypeError: 'nth' index must be an integer, got <class 'str'>.",
        )
        ...
        self.assertEqual(
            str(cm.exception),
            "TypeError: 'nth' index must be an integer, got <class 'float'>.",
        )
