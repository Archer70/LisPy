...
class TestPromiseFunctions(unittest.TestCase):
    ...
    def test_promise_wrong_arg_count(self):
        ...
        self.assertEqual(str(cm.exception), "SyntaxError: 'promise' expects 1 argument (function), got 0.")
        
        with self.assertRaises(EvaluationError) as cm:
            builtin_promise([lambda: 1, lambda: 2], self.env)
        self.assertEqual(str(cm.exception), "SyntaxError: 'promise' expects 1 argument (function), got 2.")
    
    def test_promise_non_callable_arg(self):
        """Test promise with non-callable argument."""
        with self.assertRaises(EvaluationError) as cm:
            builtin_promise([42], self.env)
        self.assertEqual(str(cm.exception), "TypeError: 'promise' argument must be a function, got int.")
        
        with self.assertRaises(EvaluationError) as cm:
            builtin_promise(["string"], self.env)
        self.assertEqual(str(cm.exception), "TypeError: 'promise' argument must be a function, got str.")
    ...
    def test_resolve_wrong_arg_count(self):
        ...
        self.assertEqual(str(cm.exception), "SyntaxError: 'resolve' expects 1 argument (value), got 0.")
        
        with self.assertRaises(EvaluationError) as cm:
            builtin_resolve([1, 2], self.env)
        self.assertEqual(str(cm.exception), "SyntaxError: 'resolve' expects 1 argument (value), got 2.")
    ...
    def test_reject_wrong_arg_count(self):
        ...
        self.assertEqual(str(cm.exception), "SyntaxError: 'reject' expects 1 argument (error), got 0.")
        
        with self.assertRaises(EvaluationError) as cm:
            builtin_reject([1, 2], self.env)
        self.assertEqual(str(cm.exception), "SyntaxError: 'reject' expects 1 argument (error), got 2.")
