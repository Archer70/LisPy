...
class GreaterThanOrEqualFunctionTest(unittest.TestCase):
    ...
    def test_greater_than_or_equal_false(self):
        ...
        self.assertFalse(run_lispy_string("(>= 4.9 5)", self.env))

    def test_greater_than_or_equal_type_error_arg_count(self):
    ...
    def test_greater_than_or_equal_type_error_non_numeric(self):
