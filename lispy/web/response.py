...
def format_response(
    response_data: Dict[Symbol, Any], enhance_json: bool = False
...
def create_error_response(
    ...
    error_body = json.dumps({"error": message, "status": status_code}, indent=2)
...
def create_method_not_allowed_response(
