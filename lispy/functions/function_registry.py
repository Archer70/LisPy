...
class FunctionDiscovery:
    ...
    def _get_decorator_registered(
        self,
    ) -> Tuple[Dict[str, Any], Dict[str, Any], Dict[str, str]]:
        """Get functions registered via decorators."""
        try:
            from .decorators import (get_registered_documentation,
    ...
    def _ensure_initialized(self):
        ...
        if not self._initialized:
            ...
            (
                ...
                self.documentation,
                self.web_unsafe,
            ) = self.discovery.discover_in_package(
                functions_package_path, "lispy.functions"
            )
